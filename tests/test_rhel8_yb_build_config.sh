...
assert_contains molecule/xcluster/molecule.yml 'MOLECULE_VM_DIR'
assert_contains molecule/backup-restore/molecule.yml 'MOLECULE_VM_DIR'
assert_contains molecule/default/molecule.yml 'UserKnownHostsFile=\$\{MOLECULE_VM_DIR:-\.vms\}/known_hosts'
assert_contains molecule/xcluster/molecule.yml 'UserKnownHostsFile=\$\{MOLECULE_VM_DIR:-\.vms\}/known_hosts'
assert_contains molecule/backup-restore/molecule.yml 'UserKnownHostsFile=\$\{MOLECULE_VM_DIR:-\.vms\}/known_hosts'
...
assert_not_contains molecule/default/molecule.yml '\$\{MOLECULE_PROJECT_DIRECTORY\}/\.vms/known_hosts'
assert_not_contains molecule/xcluster/molecule.yml '\$\{MOLECULE_PROJECT_DIRECTORY\}/\.vms/known_hosts'
assert_not_contains molecule/backup-restore/molecule.yml '\$\{MOLECULE_PROJECT_DIRECTORY\}/\.vms/known_hosts'
